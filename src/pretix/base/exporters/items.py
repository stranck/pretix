...
class ItemDataExporter(ListExporter):
    ...
    def iterate_list(self, form_data):
        ...
        header += [
            ...
            _("Allow orders containing this product to be canceled or changed"),
            _("Allow positions of this product to be canceled"),
            _("Allow positions of this product to be changed"),
            ...
            if vars:
                for v in vars:
                    ...
                    row += [
                        ...
                        _("Yes") if i.allow_position_cancel else "",
                        _("Yes") if i.allow_position_change else "",
